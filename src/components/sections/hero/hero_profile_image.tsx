    ...
    return (
        <>
            ...
            >
                ...
                <div className="absolute inset-0 overflow-hidden rounded-2xl border- border-main-green">
                    <Image
                        src={imageUrl}
                        alt={name}
                        fill
                ...
                {openToWork && (
                    <Badge
                        className={cn(
                            ...
                            "rounded-full border border-white bg-button-green/20 backdrop-blur-sm",
                            "px-2.5 py-2.5 text-[11px] sm:px-3 sm:text-xs font-medium text-main-text hover:bg-black/70"
                        )}
                    >
