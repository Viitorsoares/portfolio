...
export default function HeroProfileDescription() {
    return (
        <div className="w-full flex flex-col gap-5 sm:gap-6 items-start">
            <div className="flex flex-col gap-4 sm:gap-5 text-main-text">
                <h2 className="text-xl sm:text-22 font-medium">Olá, eu sou <span className="text-main-green">Vitor Soares</span></h2>
                <h1 className="font-medium text-3xl sm:text-4xl lg:text-5xl text-white text-balance">Desenvolvedor Full-Stack</h1>
                <p className="text-sm sm:text-base max-w-prose">Desenvolvedor Full-Stack em constante evolução. Apaixonado por transformar
