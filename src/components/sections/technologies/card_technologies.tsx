...
export default function CardTechnologies({
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-2 rounded-xl py-3.5 bg-cards border border-transparent transition-all duration-300 ease-in-out hover:border-button-green hover:-translate-y-2 hover:shadow-xl">
